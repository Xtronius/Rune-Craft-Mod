...
public class ContainerBank extends Container {
    ...
    public Slot getSlotFromInventory(IInventory inv, int slotIndex) {
        for (int j = 0; j < this.inventorySlots.size(); ++j) {
            ...
            if (slot.isSlotInInventory(inv, slotIndex)) {
                return slot;
            }
        }
    ...
    public Slot getSlot(int slotIndex) {
        return (Slot)this.inventorySlots.get(slotIndex);
    }
        ...
        else
        {
            ...
            if ((par3 == 0 || par3 == 1) && (par2 == 0 || par2 == 1))
            {
                ...
                else if (par3 == 1)
                {
                    ...
                    {
                        itemstack3 = this.transferStackInSlot(player, par1);
                        ...
                        if (itemstack3 != null)
                        {
                            ...
                            {
                                this.retrySlotClick(par1, par2, true, player);
                            }
                        }
                    }
                }
            ...
            else if (par3 == 3 && player.capabilities.isCreativeMode && inventoryplayer.getItemStack() == null && par1 >= 0)
            {
                slot2 = (Slot)this.inventorySlots.get(par1);
