...
public class PacketStrengthExpUNL  implements IPacket{
	
    float i;
    
    public PacketStrengthExpUNL(){}
    
    public PacketStrengthExpUNL(float i) {
        this.i = i;
    }
...
//        System.out.println("Recieved packet with the int i = " + i);
	...
	public void executeClient(EntityPlayer player) {
		...
		if(props != null)
			ExtendedPlayer.get(player).setExpUntilNextLvl("Strength", i);
	}
