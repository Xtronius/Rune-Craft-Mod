...
public class PacketWoodCuttingExpUNL  implements IPacket{
	
    float i;
    
    public PacketWoodCuttingExpUNL(){}
    
    public PacketWoodCuttingExpUNL(float i) {
        this.i = i;
    }
...
//        System.out.println("Recieved packet with the int i = " + i);
	...
	public void executeClient(EntityPlayer player) {
		...
		if(props != null)
			ExtendedPlayer.get(player).setExpUntilNextLvl("WoodCutting", i);
	}
