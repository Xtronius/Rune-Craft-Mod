...
public class PacketFireMakingExp  implements IPacket{
	
    float i;
    
    public PacketFireMakingExp(){}
    
    public PacketFireMakingExp(float i) {
        this.i = i;
    }
...
//        System.out.println("Recieved packet with the int i = " + i);
	...
	public void executeClient(EntityPlayer player) {
		...
		if(props != null)
			ExtendedPlayer.get(player).setExp("FireMaking", i);
	}
