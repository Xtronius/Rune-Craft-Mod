...
public class PacketAttackExpUNL  implements IPacket{
	
    float i;
    
    public PacketAttackExpUNL(){}
    
    public PacketAttackExpUNL(float i) {
        this.i = i;
    }
...
//        System.out.println("Recieved packet with the int i = " + i);
	...
	public void executeClient(EntityPlayer player) {
		...
		if(props != null)
			ExtendedPlayer.get(player).setExpUntilNextLvl("Attack", i);
	}
