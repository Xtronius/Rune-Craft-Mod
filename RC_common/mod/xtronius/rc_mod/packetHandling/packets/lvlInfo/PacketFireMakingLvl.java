...
public class PacketFireMakingLvl  implements IPacket{
	
    int i;
    
    public PacketFireMakingLvl(){}
    
    public PacketFireMakingLvl(int i) {
        this.i = i;
    }
...
//        System.out.println("Recieved packet with the int i = " + i);
	...
	public void executeClient(EntityPlayer player) {
		...
		if(props != null)
			ExtendedPlayer.get(player).setLvl("FireMaking", i);
	}
