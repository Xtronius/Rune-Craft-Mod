...
public class PacketMiningExpUNL  implements IPacket{
	
    float i;
    
    public PacketMiningExpUNL(){}
    
    public PacketMiningExpUNL(float i) {
        this.i = i;
    }
...
//        System.out.println("Recieved packet with the int i = " + i);
	...
	public void executeClient(EntityPlayer player) {
		...
		if(props != null)
			ExtendedPlayer.get(player).setExpUntilNextLvl("Mining", i);
	}
