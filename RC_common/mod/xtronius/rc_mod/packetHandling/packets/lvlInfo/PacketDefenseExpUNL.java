...
public class PacketDefenseExpUNL  implements IPacket{
	
    float i;
    
    public PacketDefenseExpUNL(){}
    
    public PacketDefenseExpUNL(float i) {
        this.i = i;
    }
...
//        System.out.println("Recieved packet with the int i = " + i);
	...
	public void executeClient(EntityPlayer player) {
		...
		if(props != null)
			ExtendedPlayer.get(player).setExpUntilNextLvl("Defense", i);
	}
